...
对照日期：2026-09-10，上游来源 [eve.dev/llms.txt](https://eve.dev/llms.txt)、[eve.dev/sitemap.md](https://eve.dev/sitemap.md) 与 [vercel/eve docs](https://github.com/vercel/eve/tree/main/docs)。记住的上游 docs tip SHA：`a24b68c5774bffeb0e4e762c3aab3ec7ab64a179`（相对上次 `c952497c`：Kybernesis Arcana memory、Datadog eval reporter、`defineDurableCallback`）。llms.txt fingerprint：sha256 `be2f43bd4730671fc87abd72a14ffe9a48a0415ad4edf39bd3e0ea9db991eb2c`。
